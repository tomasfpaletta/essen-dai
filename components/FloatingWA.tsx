  ...
  return (
    <div className="fixed bottom-6 right-5 z-40">
      ...
      <a href={waHref} target="_blank" rel="noopener noreferrer"
        className="relative w-14 h-14 bg-teal rounded-full flex items-center justify-center shadow-xl shadow-teal/40 hover:bg-teal-dark hover:scale-110 transition-all">
